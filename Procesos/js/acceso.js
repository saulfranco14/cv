...
function contacto () {
   mostrarVentanaModal('Debes de tener una sesión. <br/> <br/> <strong>Visita</strong> <a href="digitaljaguar.com.mx">  Digital Jaguar.</a>');
}
...
function exitoVerificarAcceso(jsonRespuesta, estatusRespuesta, jqXHR)
{
    ...
    if (arrayRespuesta[0].toString().length == 40) {
        ...
        if (arrayRespuesta[1] == 'alumno') {
            document.location.assign('menuAlumno.html');//Si agrega la pagina al historial
        } else if (arrayRespuesta[1] == 'socio') {
            document.location.assign('menuSocio.html');//Si agrega la pagina al historial
            //socument.location.replace('menu.html');//No agrega la pagina al historial
        } else if (arrayRespuesta[1] == 'administrador') {
            document.location.assign('menuAdministrador.html');//Si agrega la pagina al historial
            //socument.location.replace('menu.html');//No agrega la pagina al historial
        }
        return;
    } else {
